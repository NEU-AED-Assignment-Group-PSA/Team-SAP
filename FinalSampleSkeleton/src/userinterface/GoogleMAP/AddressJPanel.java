...
public class AddressJPanel extends javax.swing.JPanel {
    ...
    public AddressJPanel(JPanel userProcessContainer) {
        initComponents();
    ...
    private void setLocationBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_setLocationBtnActionPerformed
        ...
        try {
            ...
            if (userProcessContainer.getComponent(componentArray.length - 1) instanceof CreateNewPatientJPanel) {
                CreateNewPatientJPanel newPatientJPanel = (CreateNewPatientJPanel) userProcessContainer.getComponent(componentArray.length - 1);
                newPatientJPanel.populateLongituteLatitude(locationPoint);
            }else if(userProcessContainer.getComponent(componentArray.length - 1) instanceof ViewPatientJPanel){
